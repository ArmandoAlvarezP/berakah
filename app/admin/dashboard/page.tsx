                ...
                <table className="border-collapse block md:table">
                    ...
                    <tbody className="block md:table-row-group">
                        <tr className="border border-grey-500 md:border-none block md:table-row">
                            ...
                            <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3 md:hidden font-bold mr-2 sm:mr-0">Institución Emisora</span>
                                <div className="flex flex-row">
                                    <ol>
                                        <li className="ml-5 
                            ...
                            <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell"><span className="inline-block w-1/3 md:hidden font-bold mr-2 sm:mr-0">Institución Autorizada</span>
                                <div className="flex flex-row">
                                    <ol>
                                        <li className="ml-5 
                                        list-decimal">Berakah Consultoria</li>
